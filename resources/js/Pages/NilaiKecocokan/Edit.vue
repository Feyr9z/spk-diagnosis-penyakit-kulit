...
const form = useForm({
    penyakit_id: props.nilaiKecocokan.penyakit_id,
    gejala_id: props.nilaiKecocokan.gejala_id,
    nilai: props.nilaiKecocokan.nilai,
});

const submit = () => {
    form.put(route('nilai-kecocokan.update', props.nilaiKecocokan.id), {
        preserveScroll: true,
    });
};
</script>
...
<template>
    <Head title="Edit Nilai Kecocokan" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">
                Edit Nilai Kecocokan
            </h2>
        </template>
