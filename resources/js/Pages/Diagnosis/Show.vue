...
import { TableProperties, Calculator, Stethoscope, User, Calendar, RefreshCcw, ArrowLeft, Activity, FileText, AlertCircle } from 'lucide-vue-next';
...
const severityAlert = computed(() => {
    const level = hasilSAW.value?.ranking?.[0]?.penyakit?.tingkat_keparahan;
...
const hasilSAW = computed(() => props.hasilSAW);
</script>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="rounded-2xl border border-slate-200/60 dark:border-slate-700/50 bg-white/80 dark:bg-slate-800/50 shadow-sm backdrop-blur-xl p-6 transition-colors">
                        <div class="flex items-center gap-2 mb-4 pb-4 border-b border-slate-200 dark:border-slate-700">
                            ...
                            <!-- Severity Alert for top result -->
                        <div v-if="hasilSAW.ranking?.length" class="mt-4 flex items-start gap-2 rounded-xl border p-3" :class="severityAlert.class">
