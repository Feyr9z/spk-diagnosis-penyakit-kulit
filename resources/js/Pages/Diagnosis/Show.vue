    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-4">
                <Link :href="route('diagnosis.create')" class="p-2 rounded-xl bg-slate-100 dark:bg-slate-800/50 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors border border-slate-200 dark:border-slate-700/50">
        ...
        <div class="space-y-6 max-w-7xl mx-auto pb-12">
            ...
            <div class="rounded-2xl border border-slate-200/60 dark:border-slate-700/50 bg-white/80 dark:bg-slate-800/50 shadow-sm backdrop-blur-xl p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 transition-colors">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-slate-500 dark:text-slate-400 flex items-center gap-2 mt-1">
            ...
            <div v-if="activeTab === 'hasil'" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="rounded-2xl border border-slate-200/60 dark:border-slate-700/50 bg-white/80 dark:bg-slate-800/50 shadow-sm backdrop-blur-xl p-6 transition-colors">
                        ...
                        <p class="mt-6 text-xs text-slate-500 dark:text-slate-500 font-semibold italic">
                ...
                <div class="flex justify-end gap-4 mt-8">
                    <Link
                        ...
                        class="rounded-xl border border-slate-300 dark:border-slate-600 bg-transparent px-5 py-2.5 text-sm font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white transition-colors"
                    >
            ...
            <div v-if="activeTab === 'matriks-x'" class="rounded-2xl border border-slate-200/60 dark:border-slate-700/50 bg-white/80 dark:bg-slate-800/50 shadow-sm backdrop-blur-xl p-6 transition-colors">
                ...
                <p class="text-sm font-medium text-slate-600 dark:text-slate-400 mb-6">Matriks bobot kecocokan antara semua alternatif (penyakit) dan gejala pasien terpilih.</p>
            ...
            <div v-if="activeTab === 'matriks-r'" class="rounded-2xl border border-slate-200/60 dark:border-slate-700/50 bg-white/80 dark:bg-slate-800/50 shadow-sm backdrop-blur-xl p-6 transition-colors">
                ...
                <p class="text-sm font-medium text-slate-600 dark:text-slate-400 mb-6">Pembagian nilai X dengan nilai max (benefit) atau min (cost) setiap kriteria.</p>
                <div class="overflow-x-auto rounded-xl border border-slate-200 dark:border-slate-700/50">
                    <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-700/50">
                        <thead class="bg-slate-50 dark:bg-slate-800">
                            <tr>
            ...
            <div v-if="activeTab === 'preferensi-v'" class="rounded-2xl border border-slate-200/60 dark:border-slate-700/50 bg-white/80 dark:bg-slate-800/50 shadow-sm backdrop-blur-xl p-6 transition-colors">
                ...
                <p class="text-sm font-medium text-slate-600 dark:text-slate-400 mb-6">Perkalian nilai R dengan bobot W, kemudian dijumlahkan untuk mendapatkan ranking.</p>
