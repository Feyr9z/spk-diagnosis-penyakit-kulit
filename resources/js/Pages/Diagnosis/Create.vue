    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-2xl font-bold leading-tight text-slate-900 dark:text-white flex items-center gap-2">
                <Stethoscope class="w-6 h-6 text-indigo-600 dark:text-indigo-400" />
                Diagnosis SPK SAW
            </h2>
        </template>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2 md:col-span-2">
                            ...
                            <input
                                ...
                                class="block w-full rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900/50 px-4 py-3 text-sm text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:border-indigo-500 focus:ring-indigo-500/50 transition-colors"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    class="block w-full rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900/50 px-4 py-3 pl-11 text-sm text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:border-indigo-500 focus:ring-indigo-500/50 transition-colors"
                        ...
                        <div class="space-y-2">
                            ...
                            <select
                                ...
                                class="block w-full rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900/50 px-4 py-3 text-sm text-slate-900 dark:text-white focus:border-indigo-500 focus:ring-indigo-500/50 transition-colors"
                ...
                <div class="rounded-2xl border border-slate-200/60 dark:border-slate-700/50 bg-white/80 dark:bg-slate-800/50 shadow-sm backdrop-blur-xl p-6 md:p-8 transition-colors">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        <label
                            ...
                            :class="form.gejala_ids.includes(item.id) ? 'border-indigo-300 dark:border-indigo-500 bg-indigo-50 dark:bg-indigo-500/10 shadow-[0_0_15px_rgba(99,102,241,0.05)] dark:shadow-[0_0_15px_rgba(99,102,241,0.15)]' : 'border-slate-200 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-900/30 hover:bg-slate-100 dark:hover:bg-slate-800 hover:border-slate-300 dark:hover:border-slate-600'"
                        >
                            <div class="flex items-center h-5">
                                <input
                                    ...
                                    class="h-5 w-5 rounded border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900/50 text-indigo-600 dark:text-indigo-500 focus:ring-indigo-500 focus:ring-offset-white dark:focus:ring-offset-slate-900 transition-colors"
                                />
                            </div>
                            <div class="flex flex-col flex-1">
                                <span class="text-sm font-bold transition-colors" :class="form.gejala_ids.includes(item.id) ? 'text-indigo-700 dark:text-indigo-300' : 'text-slate-700 dark:text-slate-300'">
                                    {{ item.kode_gejala }}
                                </span>
