                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-center text-sm font-medium">
                                    ...
                                    <template v-else>
                                        <div class="flex items-center justify-center gap-4">
                                            <Link :href="route('gejala.edit', item.id)" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 transition-colors" title="Edit">
                                                <Edit class="w-4 h-4" />
                                            </Link>
