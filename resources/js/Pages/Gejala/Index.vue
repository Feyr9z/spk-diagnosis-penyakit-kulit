                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-center text-sm font-medium">
                                    ...
                                    <template v-else>
                                        <div class="flex items-center justify-center gap-4">
                                            <Link :href="route('gejala.edit', item.id)" class="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 transition-colors" title="Edit">
                                                <Edit class="w-4 h-4" />
                                            </Link>
